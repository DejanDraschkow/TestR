...
message.data$message.8 <- sapply(strsplit(as.character(message.data$message.2), '_'),"[",4)
...
save(eye.mov.data, file = paste(raw.data.path, "sampleData/samples_", sample.data.file.name,".Rda", sep = ""))
